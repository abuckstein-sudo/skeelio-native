...
export const LADDERS: Record<Operation, Tier[]> = {
  ...
  multiplication: [
    ...
    { id: "M2", label: "×5", gen: { kind: "mulFacts", factors: [5], otherMin: 1, otherMax: 12 } },
    { id: "M3", label: "×3, ×4", gen: { kind: "mulFacts", factors: [3, 4], otherMin: 1, otherMax: 12 } },
    { id: "M4", label: "×6, ×7, ×8, ×9", gen: { kind: "mulFacts", factors: [6, 7, 8, 9], otherMin: 1, otherMax: 12 } },
    { id: "M5", label: "×11, ×12", gen: { kind: "mulFacts", factors: [11, 12], otherMin: 2, otherMax: 12 } },
