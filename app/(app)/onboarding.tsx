...
const SLIDES = [
  ...
  { id: "teach", title: "Teaches, then checks its work", body: "Skeelio explains each idea in kid-friendly French, then gives practice it verifies itself, so your child learns the right thing." },
